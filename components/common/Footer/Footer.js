    ...
    <footer className=" text-dark">
      <div className="max-w-screen-xl p-8 m-auto">
            ...
            <div className="hidden mb-4 md:block">
              <Link href="/">
                <div className="flex gap-4 items-center">
                  <Image
                    src="https://stvinaprod.vtvcab.vn/58b0926d-7b1a-4753-a025-b6ab375e46ee.png"
                    width={74}
                    height={74}
                  />
                  <div className="min-w-[3px] bg-slate-400 h-16"></div>
                  <div className="text-2xl text-dark font-medium">vinaphone</div>
                </div>
              </Link>
            </div>
            <p className="mb-4 mt-2 text-sm text-justify" style={{ maxWidth: 500 }}>
              Ứng dụng xem trực tiếp thế thao, bóng đá.
            </p>
            <div className="flex space-x-4 items-center">
              ...
              <div className="mt-2">
                <a href="http://online.gov.vn/Home/WebDetails/88056" target="__blank" className="hidden md:block">
                  <Image
                    src="https://stvinaprod.vtvcab.vn/cae45c4d-9603-4048-adf7-fce15291cb88.png"
                    width={100}
                    height={38}
                  />
                </a>
              ...
              <div className="">
                ...
                <div className="md:flex">
                  <div className="mr-6 hidden md:flex">
                    {/* <span style={{ width: 89, height: 80 }}>{QrcodeOnlus}</span> */}
                  </div>
                  <div className="flex md:block">
                    <div className="mb-1 mr-6 md:mr-0">
                      ...
                      >
                        <Image
                          src="https://stvinaprod.vtvcab.vn/91af4b21-6541-4aac-b557-eedde81a0f0a.png"
                          width={121}
                          height={35}
                        />
                      </a>
                    ...
                    <div>
                      <div style={{ height: 35 }}>
                        ...
                        >
                          <Image
                            src="https://stvinaprod.vtvcab.vn/3c3bd6a8-bf15-48ab-9bcb-ec12ced5598e.png"
                            width={121}
                            height={35}
                          />
                        </a>
        ...
        <div className="flex flex-col-reverse md:grid grid-cols-3 text-sm gap-4">
          <div className="col-span-2 text-darks text-xs leading-5">
            ...
            <div>
              ...
              <br />
              Điện thoại: 1800 1091/ 1900 1515 &nbsp;&nbsp;&nbsp;&nbsp; Email: info@vtvcab.vn
            </div>
