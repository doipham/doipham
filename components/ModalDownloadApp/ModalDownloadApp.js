      ...
      {visible && (
        <div className="fixed z-50 inset-0 bg-dark-700 flex items-center justify-center">
          <div className="text-center p-8">
            ...
            <div className="text-xl text-dark-100 font-semibold mb-4">Tải app On+ ngay!</div>
            <div className="flex mb-4 items-center justify-center">
              <div className="p-2 rounded-xl border border-gray-500 mr-4 fix_img">
                <Image
                  src="https://stvinaprod.vtvcab.vn/c2daf902-f809-4970-a09c-37d1ca492408.png"
                  width={102}
                  height={102}
                />
              </div>
              <div>
                <div className="mb-3 mt-1">
                  ...
                  >
                    <Image
                      src="https://stvinaprod.vtvcab.vn/06572fd3-d278-4673-8377-909cf488cb08.png"
                      width={164.5}
                      height={45}
                    />
                  </a>
                ...
                <div>
                  ...
                  >
                    <Image
                      src="https://stvinaprod.vtvcab.vn/c5f614fc-2aa8-4806-b971-bddea5b709df.png"
                      width={164.5}
                      height={45}
                    />
                  </a>
