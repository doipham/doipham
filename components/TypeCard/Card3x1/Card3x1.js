...
function CardCategory({ is_live, name, thumbnail, start_time, status, is_premium, hideText, package_type }) {
  ...
  return (
    <div onClick={nextPath} role="button" tabIndex="0" onKeyPress={() => {}}>
      <div className="relative">
        <div className="relative wapper__play">
          <div className="fix_img mb-2">
            <Image
              ...
              height={144}
              alt={name}
              onError={() => setSrcImage("https://stvinaprod.vtvcab.vn/94f98a7a-6ded-4e15-ac0e-27c26829307c.png")}
            />
            {/* {is_premium && (
              <div
        ...
        {!hideText && (
          <>
            <div className="line-clamp-2 text-base bottom-0 left-0 w-full text-dark-100 font-bold">{name}</div>
          </>
        )}
      </div>
    </div>
